...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  const items: NavigationItem[] = [
    ...
    {
      key: '/organizations/:organizationId/properties',
      label: 'Properties',
      position: 'leftbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/properties'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/transactions',
      label: 'Transactions',
      position: 'leftbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/transactions'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/calendar',
      label: 'Calendar',
      position: 'leftbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/calendar'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
