...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.AddressInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).address.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.AddressInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).address.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.AddressInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).address.findFirst(input as any))),

        findMany: procedure.input($Schema.AddressInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).address.findMany(input as any))),
        ...
        count: procedure.input($Schema.AddressInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).address.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.AddressCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.AddressCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.AddressCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.AddressCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.AddressCountArgs>, 'cursor'>,
